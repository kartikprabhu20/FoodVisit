...
public class RestaurantInfo implements Parcelable{
    ...
    public RestaurantInfo(String id, String name, String backdropImage,
                          Location location, UserRating userRating,
                          String costforTwo, String priceRange, String hasOnlineDelivery, String hasTableBooking){
        this.id = id;
        this.name = name;
        this.featuredImage = backdropImage;
        this.location = location;
        this.userRating = userRating;
        this.averageCostForTwo = Integer.valueOf(costforTwo);
        this.priceRange = Integer.valueOf(priceRange);
        this.hasOnlineDelivery = Integer.valueOf(hasOnlineDelivery);
        this.hasTableBooking = Integer.valueOf(hasTableBooking);
    }
    ...
    public String getHasOnlineDelivery() {
        return String.valueOf(hasOnlineDelivery);
    }
    ...
    public String getHasTableBooking() {
        return String.valueOf(hasTableBooking);
    }
